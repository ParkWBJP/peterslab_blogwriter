const PLBW = (() => {
  ...
  const translations = {
    ko: {
      ...
      ideaIntroBody: "트렌드를 하나 고른 뒤 제목과 글 방향을 정하면 초안 작성 단계로 넘어갑니다.",
      ...
      ideaPreparing: "AI가 제목 후보를 만들고 있습니다.",
      ideaReady: "제목 제안이 준비되었습니다.",
      writingNeedSelections: "트렌드를 고른 뒤 제목 하나를 먼저 선택해 주세요.",
      titlePickGuide: "아래 제목 중 하나를 선택해 주세요.",
      titleChosenLabel: "선택됨",
      draftLengthRetryMessage: "초안 길이가 부족해 내용을 더 보강하고 있습니다. 잠시 후 다시 확인해 주세요.",
      draftLengthFailure: "초안 길이가 기준에 미치지 못했습니다. 다시 생성하면 더 긴 버전으로 재작성합니다.",
    ...
    en: {
      ...
      ideaIntroBody: "Select one trend, choose a title, and set the direction before drafting starts.",
      ...
      ideaPreparing: "The AI is preparing title suggestions.",
      ideaReady: "Title suggestions are ready.",
      writingNeedSelections: "Choose a trend and select one title first.",
      titlePickGuide: "Select one title below to continue.",
      titleChosenLabel: "Selected",
      draftLengthRetryMessage: "The draft is being expanded to meet the required length. Please wait a moment.",
      draftLengthFailure: "The draft did not reach the required length. Try again to generate a longer version.",
    ...
    ja: {
      ...
      ideaIntroBody: "トレンドを選び、タイトルと記事の方向を決めると下書き作成へ進みます。",
      ...
      ideaPreparing: "AI がタイトル案を作成しています。",
      ideaReady: "タイトル案の準備ができました。",
      writingNeedSelections: "トレンドを選び、タイトルを1つ選択してください。",
      titlePickGuide: "下のタイトル案から1つ選んでください。",
      titleChosenLabel: "選択中",
      draftLengthRetryMessage: "文字数が足りないため、本文を補強しながら再調整しています。少しお待ちください。",
      draftLengthFailure: "下書きの文字数が基準に届きませんでした。再生成すると、より長い文書で作り直します。",
